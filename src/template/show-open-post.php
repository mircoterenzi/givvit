...
<div>
    <article class="mainpost mb-4 p-4 shadow-sm rounded-5 bg-white" id="<?php echo $post_full["post_id"]; ?>">
        <div class="row">
            ...
            <?php else:?>
                <div class="col d-flex text-end justify-content-end">
                <svg id="delete" data-bs-toggle="modal" data-bs-target="#rm-post-modal"
                    xmlns="http://www.w3.org/2000/svg" width="20" class="clickable bi bi-trash3-fill" viewBox="0 0 16 16">
...
<?php include("./components/remove-post-modal.php"); ?>
        ...
        <article class="mainpost mb-4 p-4 shadow-sm rounded-5 bg-white" id="<?php echo $post_full["post_id"]; ?>">
            ...
            <a class="badge" href="explore.php?topic=<?php echo $post_full["topic"]; ?>"><?php echo $post_full["topic"]; ?></a>
                ...
                <div class="col text-end">
                    ...
                    ?>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="empty-star bi bi-star" viewBox="0 0 16 16" value ="<?php echo $post_full["post_id"]; ?>" >
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 col-2 d-flex justify-content-left">
                    <svg xmlns="http://www.w3.org/2000/svg" id = 'send-comment' width="16" height="16" fill="currentColor" class="send bi bi-send-fill" viewBox="0 0 16 16" post-id ="<?php echo $post_full["post_id"]; ?>">

<?php if(!empty($templateParams["notifications"])): ?>
    ...
    <article class="notification container m-2 p-3 rounded-5" id="<?php echo $notification["notification_id"]; ?>" <?php if($notification["visualized"]){ echo('style="opacity: 0.5;"'); } ?> />
        <div class="row">
            <div class="col-1">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" class="bi bi-piggy-bank-fill" viewBox="0 0 16 16" alt="donation icon">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="20" class="bi bi-chat-left-dots" viewBox="0 0 16 16" alt="comment icon">
                    <path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
                    <path d="M5 6a1 1 0 1 1-2 0 1 1 0 0 1 2 0m4 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0m4 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0"/>
                </svg>
                <?php elseif($notification["notification_type"] == "Like"): ?>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" class="bi bi-star-fill" viewBox="0 0 16 16" alt="like icon">
            ...
            <div class="col-3 text-end">
                <a href="
                    ...
                    ?>
                    ">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" class="bi bi-arrow-up-right-circle ms-2" viewBox="0 0 16 16">

<?php if(!empty($templateParams["notifications"])): ?>
    ...
    <article class="notification row p-2 mt-2 rounded-3 border" id="<?php echo $notification["notification_id"] ?>">
            <div class="col-auto">
            ...
            <div class="col-auto text-end">
                <a href="
                    ...
                    switch($notification["notification_type"]) {
                    case "Follow":
                        echo("profile.php?id=" . $notification["user_from"]);
                        break;
                    case "Donation":
                    case "Comment":
                    case "Like":
                    ...
                    ?>
                ">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" class="bi bi-arrow-up-right-circle-fill" viewBox="0 0 16 16">

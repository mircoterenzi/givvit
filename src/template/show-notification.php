<?php if(!empty($templateParams["notifications"])): ?>
    ...
    <article class="notification d-flex p-2 mt-2 rounded-3 border" id="<?php echo $notification["notification_id"] ?>">
        <div class="row px-2">
            <div class="col-2">
                <?php if($notification["notification_type"]=="follower"): ?>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor" class="bi bi-person-fill-add" viewBox="0 0 16 16">
                    <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7m.5-5v1h1a.5.5 0 0 1 0 1h-1v1a.5.5 0 0 1-1 0v-1h-1a.5.5 0 0 1 0-1h1v-1a.5.5 0 0 1 1 0m-2-6a3 3 0 1 1-6 0 3 3 0 0 1 6 0"/>
                    <path d="M2 13c0 1 1 1 1 1h5.256A4.5 4.5 0 0 1 8 12.5a4.5 4.5 0 0 1 1.544-3.393Q8.844 9.002 8 9c-5 0-6 3-6 4"/>
                </svg>
                <?php elseif($notification["notification_type"]=="donation"): ?>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor" class="bi bi-piggy-bank-fill" viewBox="0 0 16 16">
                ...
                <?php else: ?>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor" class="bi bi-star-fill" viewBox="0 0 16 16">
        ...
        <div class="col">
            <p class="align-self-center ms-2 mb-0">
                ...
                ?>
                <!-- <span class="badge ms-2 text-bg-danger">new</span> -->
            </p>
        </div>
    </article>
    <?php endforeach; ?>

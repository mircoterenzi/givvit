<?php if(!empty($templateParams["posts"])): ?>
    ...
    <article class="card clickable post mb-4 p-4 shadow-sm rounded-5" data-link="open-post.php?postId=<?php echo $post["post_id"]; ?>">
        <div class="row">
            ...
            <div class="col text-end">
                ...
                ?>
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="empty-star bi bi-star" viewBox="0 0 16 16" owner-id ="<?php echo $post["user_id"]; ?>" post-id ="<?php echo $post["post_id"]; ?>" >

<?php if(!empty($templateParams["posts"])): ?>
    ...
    <article class="card mb-4 p-4 shadow-sm rounded-5">
        ...
        <div class="row mt-2">
            ...
            <div class="col text-end">
                <a href="template/show-open-post.php?id=<?php echo $post["post_id"]; ?>" id="<?php echo $post["post_id"]; ?>">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" class="bi bi-arrow-up-right-circle" viewBox="0 0 16 16">

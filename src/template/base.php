    ...
    <body class="container justify-content-center py-4">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col text-end">
                        <svg data-bs-toggle="modal" data-bs-target="#new-post-modal" xmlns="http://www.w3.org/2000/svg" width="25" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
        ...
        <div class="d-flex fixed-bottom justify-content-center">
            <nav class="nav p-3 mb-2 shadow-lg rounded-5">
                ...
                <a href="profile.php?id=<?php echo $_SESSION["userId"] ?>&type=posted" class="link-underline link-underline-opacity-0">

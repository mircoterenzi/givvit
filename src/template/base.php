            ...
            <div class="container">
                <div class="row">
                    <div class="col text-start pos-relative">
                        <svg data-bs-toggle="modal" data-bs-target="#notification-modal" xmlns="http://www.w3.org/2000/svg" width="25" class="clickable bi bi-bell" viewBox="0 0 16 16" alt="bell icon">
                    ...
                    <div class="col text-end">
                        <div class="d-flex justify-content-end">
                            <svg data-bs-toggle="modal" data-bs-target="#new-post-modal" xmlns="http://www.w3.org/2000/svg" width="25" class="clickable bi bi-plus-circle" viewBox="0 0 16 16" alt="plus icon">

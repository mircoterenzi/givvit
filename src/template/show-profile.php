...
<section class="card p-4 shadow-sm rounded-5" user-id="<?php echo $profile["user_id"]; ?>">
    <div class="row mb-3 align-items-center">
        ...
        <div class="col-6">
            ...
            <svg data-bs-toggle="modal" data-bs-target="#edit-profile-modal" xmlns="http://www.w3.org/2000/svg" width="22" class="bi bi-pencil-square me-2" viewBox="0 0 16 16" alt="edit icon">

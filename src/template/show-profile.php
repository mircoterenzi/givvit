...
<section class="card p-4 shadow-sm rounded-5" user-id="<?php echo $profile["user_id"]; ?>">
    <div class="row mb-3 align-items-center">
        ...
        <div class="col-6">
            ...
            <svg data-bs-toggle="modal" data-bs-target="#edit-profile-modal" xmlns="http://www.w3.org/2000/svg" width="22" class="clickable bi bi-pencil-square me-2" viewBox="0 0 16 16" alt="edit icon">
                <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
            </svg>
            <a title="logout" href="api/logout.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" class="bi bi-box-arrow-right" viewBox="0 0 16 16" alt="logout icon">
            ...
            ?>
            <svg xmlns="http://www.w3.org/2000/svg" width="25" class="add-follow bi bi-person-add" viewBox="0 0 16 16" alt="follow icon">
                <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7m.5-5v1h1a.5.5 0 0 1 0 1h-1v1a.5.5 0 0 1-1 0v-1h-1a.5.5 0 0 1 0-1h1v-1a.5.5 0 0 1 1 0m-2-6a3 3 0 1 1-6 0 3 3 0 0 1 6 0M8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4"/>
                <path d="M8.256 14a4.5 4.5 0 0 1-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484 10.68 5.711 10 8 10q.39 0 .74.025c.226-.341.496-.65.804-.918Q8.844 9.002 8 9c-5 0-6 3-6 4s1 1 1 1z"/>
            </svg>
            <?php else: ?>
            <svg data-bs-toggle="modal" data-bs-target="#rm-follow-modal" xmlns="http://www.w3.org/2000/svg" width="25" class="bi bi-person-fill-check" viewBox="0 0 16 16" alt="unfollow icon">

...
<section class="card p-4 shadow-sm rounded-5" id="<?php echo $profile["user_id"]; ?>">
    <div class="row mb-3 align-items-center">
        ...
        <div class="col-6">
            ...
            <svg data-bs-toggle="modal" data-bs-target="#user-list-modal" xmlns="http://www.w3.org/2000/svg" width="20" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
    ...
    <div class="row align-items-center">
        ...
        <div class="col text-end">
            ...
            <a href="api/logout.php">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
            ...
            ?>
            <svg xmlns="http://www.w3.org/2000/svg" width="25" fill="currentColor" class="add-follow bi bi-person-add" viewBox="0 0 16 16">
                <path d="M12.5 16a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7m.5-5v1h1a.5.5 0 0 1 0 1h-1v1a.5.5 0 0 1-1 0v-1h-1a.5.5 0 0 1 0-1h1v-1a.5.5 0 0 1 1 0m-2-6a3 3 0 1 1-6 0 3 3 0 0 1 6 0M8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4"/>
                <path d="M8.256 14a4.5 4.5 0 0 1-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484 10.68 5.711 10 8 10q.39 0 .74.025c.226-.341.496-.65.804-.918Q8.844 9.002 8 9c-5 0-6 3-6 4s1 1 1 1z"/>
            </svg>
            <?php else: ?>
            <svg data-bs-toggle="modal" data-bs-target="#rm-follow-modal" xmlns="http://www.w3.org/2000/svg" width="25" fill="currentColor" class="bi bi-person-fill-check" viewBox="0 0 16 16">

    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <ul>
                        <?php foreach($dbh->getUserFollowers($_GET["id"]) as $user): ?>
                        <li>
                            <a class="p-3" href="profile.php?id=<?php echo $user["user_id"]; ?>"><?php echo $user["username"]; ?></a>
                        </li>
                        <?php endforeach; ?>
                    </ul>
                    <h1 class="h5" id="followers">Following:</h1>
                    <ul>
                        <?php foreach($dbh->getFollowedByUser($_GET["id"]) as $user): ?>
                        <li>
                            <a class="p-3" href="profile.php?id=<?php echo $user["user_id"]; ?>"><?php echo $user["username"]; ?></a>
                        </li>
                        <?php endforeach; ?>

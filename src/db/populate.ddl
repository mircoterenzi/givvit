...
(2, 'Amazing artwork! Can\'t wait to see it in person.', '2023-02-16', 1, 3, NULL),
(2, 'The colors used are fantastic. Well done!', '2023-02-17', 2, 4, NULL),
(3, 'Interesting topics to be discussed. Looking forward to it!', '2023-03-11', 1, 5, NULL),
(3, 'History is my favorite subject. I\'ll be there!', '2023-03-12', 2, 6, NULL),
(4, 'The experiments sound intriguing! Excited for the science fair.', '2023-04-06', 1, 7, NULL),
(5, 'I am definitely joining the workshop! Health is wealth.', '2023-05-21', 1, 8, NULL),
(5, 'This workshop is much needed. Count me in!', '2023-05-22', 2, 9, NULL),
(6, 'Looking forward to expressing myself through art!', '2023-06-16', 1, 10, NULL),
(7, 'I am interested in supporting collaborative tech projects. Let\'s connect!', '2023-07-02', 1, 11, NULL),
(7, 'Any specific technologies you\'ll be working on?', '2023-07-03', 2, 12, 11),
(8, 'I love historical lectures! Will there be Q&A sessions?', '2023-08-11', 1, 13, NULL),
(9, 'The science symposium sounds intriguing. Can\'t wait!', '2023-09-06', 1, 1, NULL),
(9, 'Is there a schedule available for the symposium?', '2023-09-07', 2, 2, NULL),
(10, 'Healthcare awareness is crucial. Count me in for the campaign!', '2023-10-21', 1, 3, NULL),
(11, 'Looking forward to the art gala night! Any featured artists?', '2023-11-16', 1, 4, NULL),
(12, 'Excited for the Tech Innovations Expo! What companies will be present?', '2023-12-02', 1, 5, NULL),
(13, 'Historical documentaries are my favorite. Can\'t wait for the screening!', '2023-01-11', 1, 6, NULL),
(14, 'I am interested in joining the art workshop on abstract painting.', '2023-02-21', 1, 7, NULL),
(14, 'Is there a fee for the art workshop?', '2023-02-22', 2, 8, NULL),
(15, 'Science quiz competition sounds fun! What are the age groups?', '2023-03-06', 1, 9, NULL),
(15, 'I have kids who might be interested. Any specific topics for the quiz?', '2023-03-07', 2, 10, NULL),
(16, 'Looking forward to the Healthcare Symposium. Will there be panel discussions?', '2023-04-16', 1, 11, NULL),
(17, 'Tech Talk on future trends is right up my alley. Can\'t wait!', '2023-05-02', 1, 12, NULL),
(18, 'Historical walking tour is a great idea! Are there guided tours available?', '2023-06-11', 1, 13, NULL),
(18, 'I love history! Will there be information on the historical sites visited?', '2023-06-12', 2, 1, NULL),
(19, 'Artisan market for local creations is fantastic! Can artists apply to participate?', '2023-07-16', 1, 2, NULL),
(20, 'Health and Wellness Seminar - I am definitely attending!', '2023-08-02', 1, 3, NULL),
(21, 'Tech Hackathon sounds exciting! Any specific challenges announced?', '2023-09-06', 1, 4, NULL),
(22, 'Historical Costume Party - What\'s the dress code for the party?', '2023-10-21', 1, 5, NULL),
(23, 'Science Exhibition for Kids - I have kids who would love this!', '2023-11-16', 1, 6, NULL),
(23, 'Is there an age limit for participating in the kids\' science exhibition?', '2023-11-17', 2, 7, NULL),
(24, 'Healthcare Charity Run - Count me in for the charity run!', '2023-12-02', 1, 8, NULL),
(25, 'Art Photography Contest - Are there specific themes for the contest?', '2023-01-11', 1, 9, NULL),
(25, 'I am interested in submitting my photographs. How can I participate?', '2023-01-12', 2, 10, NULL),
(26, 'Tech Workshop on Artificial Intelligence - Is there a prerequisite for joining the workshop?', '2023-02-21', 1, 11, NULL),
(27, 'Historical Trivia Night - I love trivia! How can I participate?', '2023-03-06', 1, 12, NULL),
(28, 'Science Outreach Program - How can I volunteer for the program?', '2023-04-16', 1, 13, NULL),
(29, 'Health and Fitness Expo - I am interested in the wellness workshops.', '2023-05-02', 1, 1, NULL),
(30, 'Artistic Mural Painting Project - Count me in for the mural painting!', '2023-06-11', 1, 2, NULL),
(31, 'Tech Conference on Emerging Technologies - Any specific industries covered in the conference?', '2023-07-16', 1, 3, NULL),
(32, 'Historical Book Club - How can I join the book club?', '2023-08-02', 1, 4, NULL),
(33, 'Science Discovery Camp for Kids - Is there a registration process for the camp?', '2023-09-06', 1, 5, NULL),
(33, 'Can parents participate or observe during the science camp?', '2023-09-07', 2, 6, NULL),
(34, 'Healthcare Volunteer Day - I am interested in volunteering for the healthcare day.', '2023-10-21', 1, 7, NULL),
(35, 'Art Workshop on Pottery Making - Is there a fee for the pottery workshop?', '2023-11-16', 1, 8, NULL),
(36, 'Tech Startup Pitch Event - Can spectators attend the pitch event?', '2023-12-02', 1, 9, NULL),
(36, 'What criteria are considered for selecting pitches in the startup event?', '2023-12-03', 2, 10, NULL),
(37, 'Historical Photography Exhibition - How can photographers submit their works?', '2023-01-11', 1, 11, NULL),
(38, 'Science Documentary Screening - Any specific documentaries being screened?', '2023-02-21', 1, 12, NULL),
(39, 'Healthcare Panel Discussion - How can the audience participate in the discussion?', '2023-03-06', 1, 13, NULL),
(40, 'Art Installation Project - Can community members contribute to the art installation?', '2023-04-16', 1, 1, NULL),
(41, 'Tech Webinar on Cybersecurity Essentials - Is there a registration process for the webinar?', '2023-05-02', 1, 2, NULL),
(42, 'Historical Reenactment Festival - Can individuals participate in the reenactments?', '2023-06-11', 1, 3, NULL),
(43, 'Science Symposium on Climate Change - Will there be discussions on local climate issues?', '2023-07-16', 1, 4, NULL),
(44, 'Health and Wellness Retreat - How can individuals register for the retreat?', '2023-08-02', 1, 5, NULL),
(45, 'Artisan Market for Sustainable Creations - Can eco-friendly vendors apply for stalls?', '2023-09-06', 1, 6, NULL),
(46, 'Tech Workshop on Data Science Bootcamp - Any prerequisites for joining the bootcamp?', '2023-10-21', 1, 7, NULL),
(47, 'Historical Walking Tour: Industrial Revolution - Will there be guides providing historical insights?', '2023-11-16', 1, 8, NULL),
(48, 'Science Experiment Night for Kids - How can kids participate in the experiments?', '2023-12-02', 1, 9, NULL),
(48, 'Are there safety measures in place for the kids\' science experiment night?', '2023-12-03', 2, 10, NULL),
